...
<div class="py-12">
            ...
            <div class="p-6 text-gray-900">
                    ...
                    <?php if($tabs->count() > 0): ?>
                        ...
                        <div class="mb-8" x-data="{ 
                            activeTab: '<?php echo e($favoritesTab ? 'favorites' : ($tabs->first() ? $tabs->first()->id : '')); ?>',
                            filters: {
                                <?php if($favoritesTab): ?>
                                'favorites': {
                                    category: 'all',
                        ...
                        ">
                                ...
                                <nav class="-mb-px flex space-x-8 overflow-x-auto" aria-label="Tabs">
                                    <?php if($favoritesTab): ?>
                                        <button
                                            ...
                                            :style="activeTab === 'favorites' ? 
                                                'border-color: <?php echo e($favoritesTab->color); ?>; color: <?php echo e($favoritesTab->color); ?>; background-color: <?php echo e($favoritesTab->color); ?>15;' : 
                                                'border-color: transparent; color: <?php echo e($favoritesTab->color); ?>;'"
                                        >
                                            <i class="fas fa-star mr-2"></i>
                                            <?php echo e($favoritesTab->name); ?>
                                    ...
                                    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button
                                            ...
                                            :class="activeTab === '<?php echo e($tab->id); ?>' ? 'tab-active' : 'tab-inactive'"
                                            class="tab-button whitespace-nowrap py-3 px-4 border-b-2 font-medium text-sm transition-all duration-200 flex items-center"
                                            :style="activeTab === '<?php echo e($tab->id); ?>' ? 
                                                'border-color: <?php echo e($tab->color); ?>; color: <?php echo e($tab->color); ?>; background-color: <?php echo e($tab->color); ?>15;' : 
                                                'border-color: transparent; color: <?php echo e($tab->color); ?>;'"
                                        >
                                ...
                                <div x-show="activeTab === 'favorites'" class="mt-8" x-data="tabContent">
                                    ...
                                    <div class="mb-6 bg-gray-50 rounded-lg px-4 py-3 border border-gray-200">
                                        <div class="flex flex-wrap items-center justify-center gap-4">
                                            ...
                                            <?php if($favoriteDatacenters->count() > 0): ?>
                                                <!-- Filtro por Data Center -->
                                                <div class="flex items-center gap-2">
                                                    <label class="text-sm font-medium text-gray-700 whitespace-nowrap">
                                                    ...
                                                    <select x-model="filters['favorites'].datacenter" 
                                                        ...
                                                        <?php $__currentLoopData = $favoriteDatacenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datacenter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($datacenter->id); ?>"><?php echo e($datacenter->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                                ...
                                                <?php echo e($favoritesTab->cards->count()); ?> <?php echo e($favoritesTab->cards->count() === 1 ? 'favorito' : 'favoritos'); ?>

                                            </span>
                                        </div>
                                    </div>
                                    
                                    <?php if($favoritesTab->cards->count() > 0): ?>
                                        <div class="cards-grid">
                                            <?php $__currentLoopData = $favoritesTab->cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div x-show="shouldShowCard('<?php echo e($card->id); ?>', '<?php echo e($card->category_id); ?>', '<?php echo e($card->data_center_id ?? ''); ?>', '<?php echo e($card->name); ?>', 'favorites')"
                                                     ...
                                                     data-card-name="<?php echo e($card->name); ?>"
                                                     data-card-category="<?php echo e($card->category_id); ?>"
                                                     data-tab-id="favorites">
                                                    <div class="p-6">
                                                        <div class="flex items-center justify-between mb-4">
                                                            <div class="flex items-center">
                                                                <?php if($card->custom_icon_path): ?>
                                                                    <img src="<?php echo e($card->custom_icon_url); ?>" alt="<?php echo e($card->name); ?>" class="w-8 h-8 object-contain">
                                                                <?php elseif($card->icon): ?>
                                                                    <i class="<?php echo e($card->icon); ?> text-2xl" style="color: <?php echo e($favoritesTab->color); ?>;"></i>
                                                                <?php else: ?>
                                                                    <div class="w-8 h-8 rounded-full" style="background-color: <?php echo e($favoritesTab->color); ?>;"></div>
                                                                <?php endif; ?>
                                                            </div>
                                                            
                                                            <div class="flex items-center space-x-2">
                                                                <!-- Estrela de Favorito (sempre preenchida na aba favoritos) -->
                                                                <button onclick="toggleFavorite(<?php echo e($card->id); ?>, this)" 
                                                                ...
                                                                <?php if($card->monitor_status): ?>
                                                                    <div class="relative tooltip-container">
                                                                        <div class="flex items-center space-x-1 cursor-help">
                                                                            <div class="w-3 h-3 rounded-full <?php echo e($card->status_class); ?>" style="background-color: <?php echo e($card->status === 'online' ? '#10b981' : ($card->status === 'offline' ? '#ef4444' : '#6b7280')); ?>;"></div>
                                                                            <?php
                                                                            ...
                                                                            ?>
                                                                            <span class="text-xs font-medium <?php echo e($statusColor); ?>">
                                                                                <?php echo e($card->status_text); ?>
                                                                        ...
                                                                        <div class="tooltip-status">
                                                                            <div class="flex items-center mb-1">
                                                                                <div class="w-2 h-2 rounded-full <?php echo e($card->status_class); ?> mr-2" style="background-color: <?php echo e($card->status === 'online' ? '#10b981' : ($card->status === 'offline' ? '#ef4444' : '#6b7280')); ?>;"></div>
                                                                                <span class="font-medium"><?php echo e($card->status_text); ?></span>
                                                                            </div>
                                                                            <?php if($card->response_time): ?>
                                                                                <div class="text-xs text-gray-300">Tempo: <?php echo e($card->response_time); ?>ms</div>
                                                                            <?php endif; ?>
                                                                            <div class="text-xs text-gray-300">Verificado: <?php echo e($card->last_status_check ? $card->last_status_check->format('d/m/Y H:i:s') : 'Nunca'); ?></div>
                                                                ...
                                                                <?php if($card->description): ?>
                                                                    <div class="relative tooltip-container">
                                                                        <i class="fas fa-info-circle text-gray-400 cursor-help" style="color: <?php echo e($favoritesTab->color); ?>;"></i>
                                                                        <div class="tooltip-description">
                                                                            <div class="font-medium mb-1">Descrição</div>
                                                                            <div class="text-xs text-gray-300"><?php echo e($card->description); ?></div>
                                                                            <div class="tooltip-arrow"></div>
                                                                        </div>
                                                                    </div>
                                                                <?php endif; ?>
                                                                
                                                                <?php if($card->file_path): ?>
                                                                    <a href="<?php echo e(Storage::url($card->file_path)); ?>" target="_blank" class="text-gray-400 hover:text-gray-600 transition-colors duration-200">
                                                        ...
                                                        <div class="flex space-x-2">
                                                            <?php if($card->monitoring_type === 'ping'): ?>
                                                                <button 
                                                                    onclick="copyServerIP('<?php echo e($card->link); ?>', '<?php echo e($card->name); ?>')"
                                                                    ...
                                                                    style="background-color: <?php echo e($favoritesTab->color); ?>;"
                                                            ...
                                                            ?>
                                                            <button 
                                                                onclick="<?php echo e($hasPermission ? 'openLoginsModal(' . $card->id . ', \'' . addslashes($card->name) . '\')' : 'openAccessDeniedModal()'); ?>" 
                            ...
                            <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div x-show="activeTab === '<?php echo e($tab->id); ?>'" class="mt-8" x-data="tabContent">
                                    <!-- Filtros da Aba -->
                                    <div class="mb-6 bg-gray-50 rounded-lg px-4 py-3 border border-gray-200">
                                        <div class="flex flex-wrap items-center justify-center gap-4">
                                            <?php
                                            ...
                                            <?php if($categories->count() > 0): ?>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <select x-model="filters['<?php echo e($tab->id); ?>'].category" 
                                                            class="text-sm border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500 min-w-[120px]">
                                                        <option value="all">Todas</option>
                                            ...
                                            <?php if($datacenters->count() > 0): ?>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <select x-model="filters['<?php echo e($tab->id); ?>'].datacenter" 
                                                            class="text-sm border-gray-300 rounded-md focus:border-purple-500 focus:ring-purple-500 min-w-[120px]">
                                                        <option value="all">Todos</option>
                                                        <option value="none">Sem Data Center</option>
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <select x-model="filters['<?php echo e($tab->id); ?>'].sort" 
                                                        class="text-sm border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500 min-w-[120px]">
                                                    <option value="name">Alfabética A-Z</option>
                                                    <option value="name_desc">Alfabética Z-A</option>
                                                </select>
                                            ...
                                            <!-- Botão Limpar Filtros -->
                                            <button @click="filters['<?php echo e($tab->id); ?>'].category = 'all'; filters['<?php echo e($tab->id); ?>'].datacenter = 'all'; filters['<?php echo e($tab->id); ?>'].sort = 'name';"
                                                    class="flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-gray-600 bg-white border border-gray-300 rounded-md hover:bg-gray-50 hover:text-gray-700 transition-colors duration-200">
                                                <i class="fas fa-eraser"></i>
                                                Limpar Filtros
                                            </button>
                                            ...
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-200 text-gray-600">
                                                <?php echo e($tab->cards->count()); ?> <?php echo e($tab->cards->count() === 1 ? 'sistema' : 'sistemas'); ?>
                                    ...
                                    <?php if($tab->cards->count() > 0): ?>
                                        <div class="cards-grid">
                                            <?php $__currentLoopData = $tab->cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div x-show="shouldShowCard('<?php echo e($card->id); ?>', '<?php echo e($card->category_id); ?>', '<?php echo e($card->data_center_id ?? ''); ?>', '<?php echo e($card->name); ?>', '<?php echo e($tab->id); ?>')"
                                                     x-transition:enter="transition ease-out duration-300"
                                                     x-transition:enter-start="opacity-0 transform scale-95"
                                                     x-transition:enter-end="opacity-100 transform scale-100"
                                                     x-transition:leave="transition ease-in duration-200"
                                                        ...
                                                        <div class="flex items-center justify-between mb-4">
                                                            <div class="flex items-center">
                                                                <?php if($card->custom_icon_path): ?>
                                                                    <img src="<?php echo e($card->custom_icon_url); ?>" alt="<?php echo e($card->name); ?>" class="w-8 h-8 object-contain">
                                                                <?php elseif($card->icon): ?>
                                                                    <i class="<?php echo e($card->icon); ?> text-2xl" style="color: <?php echo e($tab->color); ?>;"></i>
                                                                <?php else: ?>
                                                                    <div class="w-8 h-8 rounded-full" style="background-color: <?php echo e($tab->color); ?>;"></div>
                                                                <?php endif; ?>
                                                            </div>
                                                            
                                                            <div class="flex items-center space-x-2">
                                                                <!-- Estrela de Favorito -->
                                                                <?php if(auth('web')->check() || auth('system')->check()): ?>
                                                                    <button onclick="toggleFavorite(<?php echo e($card->id); ?>, this)" 
                                                                            class="favorite-star <?php echo e(in_array($card->id, $favoriteCardIds) ? 'text-yellow-500 hover:text-yellow-600' : 'text-gray-300 hover:text-yellow-400'); ?> transition-colors duration-200"
                                                                            title="<?php echo e(in_array($card->id, $favoriteCardIds) ? 'Remover dos favoritos' : 'Adicionar aos favoritos'); ?>"
                                                                            data-card-id="<?php echo e($card->id); ?>"
                                                                            data-is-favorite="<?php echo e(in_array($card->id, $favoriteCardIds) ? 'true' : 'false'); ?>">
                                                                        <i class="<?php echo e(in_array($card->id, $favoriteCardIds) ? 'fas' : 'far'); ?> fa-star text-lg"></i>
                                                                    </button>
                                                                <?php endif; ?>
                                                                ...
                                                                <?php if($card->monitor_status): ?>
                                                                    <div class="relative tooltip-container">
                                                                        <div class="flex items-center space-x-1 cursor-help">
                                                                            <!-- DEBUG: Status: <?php echo e($card->status); ?>, Class: <?php echo e($card->status_class); ?> -->
                                                                            <div class="w-3 h-3 rounded-full <?php echo e($card->status_class); ?>" style="background-color: <?php echo e($card->status === 'online' ? '#10b981' : ($card->status === 'offline' ? '#ef4444' : '#6b7280')); ?>;"></div>
                                                                            <?php
                                                                                $statusColor = 'text-gray-500';
                                                                                if ($card->status === 'online') {
                                                                ...
                                                                <?php if($card->description): ?>
                                                                    <div class="relative tooltip-container">
                                                                        <i class="fas fa-info-circle text-gray-400 cursor-help" style="color: <?php echo e($tab->color); ?>;"></i>
                                                        ...
                                                        <div class="flex space-x-2">
                                                            <?php if($card->monitoring_type === 'ping'): ?>
                                                                ...
                                                                <button 
                                                                    onclick="copyServerIP('<?php echo e($card->link); ?>', '<?php echo e($card->name); ?>')"
                                                                    class="flex-1 inline-flex items-center justify-center px-4 py-2 bg-primary-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-primary-700 focus:bg-primary-700 active:bg-primary-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition ease-in-out duration-150"
                                                                    style="background-color: <?php echo e($tab->color); ?>;"
                                                                    title="Copiar IP do servidor"
                                                                >
                                                                    <i class="fas fa-copy"></i>
                                                                </button>
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4" onclick="event.stopPropagation()">
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-700 mb-4" id="accessDeniedMessage">
                        <?php echo e(auth()->check() ? 'Você não tem permissão para visualizar os logins dos sistemas.' : 'Faça login para ter acesso aos logins dos sistemas.'); ?>
                    ...
                    <div class="flex space-x-3 justify-center">
                        ...
                        <?php if(!auth()->check() && !auth()->guard('system')->check()): ?>
                            <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors duration-200">
                                Fazer Login
                            </a>
                        <?php endif; ?>
                    </div>
    ...
    <script>
        ...
        function openAccessDeniedModal() {
            if (!<?php echo e((auth()->check() || auth()->guard('system')->check()) ? 'true' : 'false'); ?>) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/Engehub/resources/views/home.blade.php ENDPATH**/ ?>