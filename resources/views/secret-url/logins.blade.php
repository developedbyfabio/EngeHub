    ...
    <div class="space-y-4">
        ...
        @else
            <div class="text-center py-8">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Nenhum login disponível</h3>
                <p class="text-gray-500 mb-4">Você não tem permissão para visualizar os logins deste sistema ou não há logins cadastrados.</p>
            </div>
        @endif
    </div>
