    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.network-maps.update', $network_map) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="space-y-6">
                            <div>
                            ...
                            <div>
                                <label for="file" class="block text-sm font-medium text-gray-700">Substituir arquivo SVG (opcional)</label>
                                <input type="file" name="file" id="file" accept=".svg" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:font-semibold file:bg-amber-50 file:text-amber-700 hover:file:bg-amber-100">
